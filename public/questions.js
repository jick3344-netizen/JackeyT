window.QUESTION_SETS = {
  personal: [
    ...
    },
    {
      ...
      help: "选择最接近当前实际情况的一项。",
      type: "single",
      options: ["尚未正式开始", "刚刚起步", "已有内容，但定位不清", "已有稳定业务", "正在升级或转型"],
    },
    {
      key: "identity",
      module: "基础信息",
    ...
    },
    {
      ...
      type: "single",
      options: ["提升结果或效果", "节省时间", "降低成本", "降低风险", "提供更好体验", "增强信心或认同", "创造新的机会"],
    },
    {
      key: "consistency",
      module: "品牌价值",
    ...
    },
    {
      ...
      help: "选择当前最有说服力的一类证据。",
      type: "single",
      options: ["专业履历或资质", "代表客户或项目", "可量化成果", "原创方法或作品", "客户评价与转介绍", "媒体、奖项或机构认可", "目前还缺少明确证据"],
    },
    {
      key: "cases",
      module: "品牌信任状",
    ...
    },
    {
      ...
      type: "scale",
      scaleLabels: ["尚未整理", "偶尔保存", "有部分积累", "定期整理", "已形成体系"],
    },
    {
      ...
      type: "single",
      options: ["暂不需要", "想先了解服务方式与价格", "需要，希望安排 1 对 1 沟通"],
    },
  ],
  corporate: [
    {
    ...
    },
    {
      ...
      type: "single",
      options: ["新建品牌", "市场验证期", "快速成长阶段", "稳定经营阶段", "品牌升级阶段", "业务转型阶段"],
    },
    {
      key: "identity",
      module: "基础信息",
    ...
    },
    {
      ...
      help: "选择最主要的一项。",
      type: "single",
      options: ["产品性能", "技术能力", "服务质量", "效率与便利", "成本优势", "安全与风险控制", "体验与情感认同", "资源或平台能力"],
    },
    {
      key: "consistency",
      module: "品牌价值",
      ...
      type: "scale",
      scaleLabels: ["主要依赖个人", "经常不稳定", "部分可兑现", "基本稳定", "体系化保障"],
    },
    {
      key: "trustAssets",
      module: "品牌信任状",
      ...
      type: "single",
      options: ["行业资质与认证", "代表客户与项目", "经营或成果数据", "专利与技术能力", "质量与服务体系", "客户评价与复购", "媒体、奖项或机构认可", "目前还缺少明确证据"],
    },
    {
      key: "cases",
      module: "品牌信任状",
    ...
    },
    {
      ...
      type: "scale",
      scaleLabels: ["没有管理", "零散保存", "部分整理", "定期维护", "形成完整体系"],
    },
    {
      key: "consultationInterest",
      module: "服务支持",
